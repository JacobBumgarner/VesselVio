...
class AnalysisOptions:
    def __init__(self, results_folder, resolution, prune_length, filter_length, max_radius, save_segment_results, save_graph, image_dimensions=3):
...
class AnnotationOptions:
    def __init__(self, annotation_filepath, atlas_filepath, annotation_type, annotation_regions):
...
class GraphOptions:
    def __init__(self, file_format='GraphML', graph_type=None, clique_filtering=None, centerline_smoothing=None, attribute_key=None, delimiter=None):
...
class AttributeKey:
    def __init__(self, X, Y, Z, vertex_radius, edge_radius, length, volume, surface_area, tortuosity, edge_source, edge_target, vis_radius=None, edge_hex=None):
        self.X = X
        self.Y = Y
        self.Z = Z
...
class VisualizationOptions:
    def __init__(self, visualize, load_simplified, load_scaled, load_network, load_original, load_smoothed, scalars='Radius', cmap='viridis', show_branches=False, show_ends=False, create_movie=False, movie_title=None, viewup=[1,1,1], render_annotations=False, rendering_quality=0):
        # Rendering options
        self.visualize = visualize
        self.load_simplified = load_simplified
        self.rendering_quality = rendering_quality # 0, 1, 2 (0 best, 2 worst based on index of combo box)
...
class PyVistaMeshes:
    def __init__(self, network=None, network_caps=None,
                 network_branches=None, network_ends=None,
                 scaled=None, scaled_caps=None,
                 scaled_branches=None, scaled_ends=None,
                 original=None, smoothed=None, id_hex_dict=None):
        ...
        self.vessels = [self.network, self.network_caps, self.network_branches, self.network_ends,
                        self.scaled, self.scaled_caps, self.scaled_branches, self.scaled_ends]
    
    def iter_vessel_meshes(self):
        vessels = [self.network, self.network_caps, 
                   self.network_branches, self.network_ends,
                   self.scaled, self.scaled_caps, 
                   self.scaled_branches, self.scaled_ends]
        return vessels
...
class PyVistaActors:
    def __init__(self, vessels=None, vessel_caps=None,
                 branches=None, ends=None,
                 volume=None):
...
class VisualizationFiles:
    def __init__(self, dataset_type='Volume', file1=None, file2=None, annotation_data=None, annotation_type='None', visualized=None):
...
class CameraActors:
    def __init__(self, path=None, path_direction=None, camera=None, lens=None, camera_legs=None):
        self.path = path
