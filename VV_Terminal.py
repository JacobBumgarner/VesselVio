...
if __name__ == "__main__":
    ...
    loading_dock(file2, short_name=short_name, Visualize=Visualize, movie=movie, title=title, resolution=resolution, gen_volume=gen_volume, gen_tubes=gen_tubes, save_labeled=save_labeled, save_graph=save_graph, verbose=verbose, iteration=iteration)
